// *******************************************************************************
// Methods for the evolutionary search class BSearch
// *******************************************************************************
...
BSearch::BSearch(int VSize, double (*EvalFn)(TVector<int> &, RandomState &))
{
...
void BSearch::SetVectorSize(int NewSize)
{
...
void BSearch::SetPopulationSize(int NewSize)
{
...
void BSearch::SetMaxGenerations(int NewMax)
{
	if (NewMax < 0) {
...
void BSearch::SetElitistFraction(double NewFraction)
{
...
void BSearch::SetMaxExpectedOffspring(double NewVal)
{
...
void BSearch::SetMutationVariance(double NewVariance)
{
	if (NewVariance <= 0.0) {
...
void BSearch::SetCrossoverProbability(double NewProb)
{
...
void BSearch::SetCrossoverTemplate(TVector<int> &NewTemplate)
{
...
void BSearch::SetCrossoverPoints(TVector<int> &NewPoints)
{
...
void BSearch::SetSearchConstraint(TVector<int> &constraint)
{
...
void BSearch::SetSearchConstraint(int flag)
{
...
void BSearch::SetCheckpointInterval(int NewInterval)
{
	if (NewInterval < 0) {
...
void BSearch::DoSearch(int ResumeFlag)
{
...
void BSearch::ExecuteSearch(void)
{
	DoSearch(0);
}
...
void BSearch::InitializeSearch(void)
{
...
void BSearch::RandomizeVector(TVector<int> &v)
{
	for (int i = 1; i <= v.Size(); i++)
		//v[i] = rs.UniformRandom(MinSearchValue,MaxSearchValue);
		v[i] = rs.UniformRandomInteger(0,1);
}


// Randomize the population

void BSearch::RandomizePopulation(void)
{
	for (int i = 1; i <= Population.Size(); i++)
...
void BSearch::UpdatePopulationStatistics(void)
{
	register int i;
	double total = 0;
	int bestindex = 1;
...
void BSearch::DisplayPopulationStatistics(void)
{
...
void BSearch::DisplaySearchResults(void)
{
...
void BSearch::ResumeSearch(void)
{
...
int BSearch::SearchTerminated(void)
{
	return (Gen >= MaxGens) ||
	       ((SearchTerminationFunction != NULL) &&
...
double BSearch::EvaluateVector(TVector<int> &v, RandomState &rs)
{
...
void BSearch::EvaluatePopulation(int start)
{
...
void BSearch::UpdatePopulationFitness(void)
{
...
void BSearch::MutateVector(TVector<int> &v)
{
	// Apply the mutation to V
	for (int i = 1; i <= vectorSize; i++)
		if (rs.UniformRandom(0,1) < MutationVar){
			if (v[i] == 0)
				v[i] = 1;
			else
				v[i] = 0;
...
void BSearch::UniformCrossover(TVector<int> &v1, TVector<int> &v2)
{
...
void BSearch::TwoPointCrossover(TVector<int> &v1, TVector<int> &v2)
{
	if (crossPoints.Size() < 2) return;
...
void BSearch::ReproducePopulation(void)
{
	switch (RepMode) {
...
void BSearch::ReproducePopulationHillClimbing(void)
{
	int psize = PopulationSize();
	...
	TVector<TVector<int> > ParentPopulation(1,psize);
...
void BSearch::ReproducePopulationGeneticAlgorithm(void)
{
	int psize = PopulationSize();
	...
	TVector<TVector<int> > TempPopulation = Population;
	int j = ElitePop+1;
	double sum = 0;
	double rand = rs.UniformRandom(0.0,1.0);
	for (int i = 1; (i <= psize) && (j <= psize); i++) {
...
inline int partition(int first, int last, TVector<double> &perf, TVector<TVector<int> > &pop)
{
	int pivot = first;
...
inline void quicksort(int first, int last, TVector<double> &perf, TVector<TVector<int> > &pop)
{
	if (first < last) {
...
void BSearch::SortPopulation(void)
{
...
void BSearch::WriteCheckpointFile(void)
{
...
void BSearch::ReadCheckpointFile(void)
{
